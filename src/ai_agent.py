...
Respond professionally with technical accuracy and provide step-by-step solutions when possible."""
    ...
    def create_user_prompt(self, ticket_data: Dict[str, Any], analysis_type: str = "full") -> str:
        """Create the user prompt for ticket analysis"""
        ...
        if analysis_type == "categorize_only":
            return f"""Analyze this GIS support ticket and respond with ONLY a JSON object:
...
{{
    ...
    "confidence": 0.95
        ...
        return f"""Analyze this GIS support ticket and provide a comprehensive response:
...
{{
    ...
    def analyze_with_rules(self, ticket_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        suggested_response = response_templates.get(category, "Thank you for contacting GIS support. I'll help you resolve this issue. Please provide more details about the specific problem you're experiencing, including any error messages and steps you've already tried.")
